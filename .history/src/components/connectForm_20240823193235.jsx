...
export default function ConnectForm() {
    const { connectRecipient, setRecipient } = useContext(PeerIdContext);
    ...
    const handleConnect = (e) => {
        ...
        setRecipient(connectPeerId); // שמירת ה-Peer ID של המשתמש הרצוי
        connectRecipient(e); // ניסיון חיבור למשתמש
