...
export default function ContactUs() {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        "service_amnfo81", // החלף ב-SERVICE ID שלך מ-EmailJS
        "YOUR_TEMPLATE_ID", // החלף ב-TEMPLATE ID שלך מ-EmailJS
        templateParams,
        "YOUR_USER_ID" // החלף ב-USER ID שלך מ-EmailJS
      )
      .then(
        (response) => {
    ...
    <section id="contact" className="py-20 bg-white dark:bg-gray-900">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">
          Have any questions? Get in touch with us and we will be happy to assist you.
        </p>
        ...
        {status && <p className="mt-4 text-green-500">{status}</p>} {/* הצגת סטטוס */}
      </div>
    </section>
  );
}
