...
export const PeerIdProvider = ({ children }) => {
    ...
    useEffect(() => {
        ...
        peer.on("connection", (con) => {
            ...
            setConfirmCallback(() => () => handleConfirmIncomingConnection(con));
            setConfirmModalData({
                title: "Incoming Connection",
                message: `Do you want to accept the connection request from ${con.peer}?`
            });
    ...
    const handleConfirmIncomingConnection = (con) => {
