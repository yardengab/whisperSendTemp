...
export default function Encrypt() {
    ...
    useEffect(() => {
        try {
            ...
            // במקרה של שגיאה (כמו בגלישה פרטית), מציגים את ה-popup
            console.warn("SessionStorage is not accessible, showing mnemonic popup.");
            setShowMnemonicPopup(true);
        }
    }, []);
            ...
            <div className="bg-white dark:bg-gray-800 p-10 rounded-xl shadow-2xl w-full max-w-5xl transform transition duration-500 hover:scale-105">
                ...
                <div className="flex flex-col md:flex-row md:justify-between md:space-x-6">
                    ...
                    <div className="flex-1 mb-8 md:mb-0">
                        ...
                        <p className="text-gray-600 dark:text-gray-400">
                            Download the encrypted file and the encryption keys. Without the
                            keys, you cannot decrypt the file in the future.
                        </p>
                    </div>
                    <div className="flex-1">
                        ...
                        <p className="text-gray-600 dark:text-gray-400">
                            Store the encryption keys securely to ensure you can access your
                            files when needed.
                        </p>
                    </div>
                </div>
