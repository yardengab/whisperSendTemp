...
export default function MessageInput() {
    const { connection, messages, setMessages, message, setMessage, myWallet, peerId, recipientPeerId, openConfirmModal, isDisconnected, initiatedDisconnect } = useContext(PeerIdContext);
    ...
    return (
        <div className="relative flex items-center space-x-4 mt-4">
            ...
            <input
                ...
                style={{ display: "none" }}
                onChange={(e) =>
                    !isDisconnected && handleSendFile({ e, connection, recipientPeerId, myWallet, peerId, setMessages, messages, openConfirmModal })
                }
            />
            ...
            <button
                onClick={() => {
                    ...
                    handleSendMessage({ message, connection, recipientPeerId, messages, myWallet, peerId, setMessages, setMessage });
                }}
